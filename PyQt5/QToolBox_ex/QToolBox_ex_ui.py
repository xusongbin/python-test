...
# Form implementation generated from reading ui file 'QToolBox_ex_ui.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 69, 179))
        self.page.setObjectName("page")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.page)
        self.verticalLayout.setObjectName("verticalLayout")
        self.toolButtonBaidu = QtWidgets.QToolButton(self.page)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/se/ico/baidu.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/se/ico/sougo.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/v/ico/tengxun.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
